...
\begin{document}
  \begin{tikzpicture}
    \begin{axis}[/pgfplots/table/ignore chars={ }, %footnotesize,
        ...
        \addplot[mark=square, Paired-1,    semithick                              ] table [x index=0, y index=13] {./dat/A15_samples_intra_32b_aff3ct_r5_6.dat}; \label{plot:line1}
        \addplot[mark=square, Paired-1!70, semithick, dashed, mark options={solid}] table [x index=0, y index=13] {./dat/A15_samples_intra_32b_aff3ct_r1_2.dat}; \label{plot:line2}
    \end{axis}
