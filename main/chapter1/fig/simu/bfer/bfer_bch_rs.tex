...
\begin{document}
  \begin{tikzpicture}
    \begin{axis}[/pgfplots/table/ignore chars={|}, %footnotesize,
        ...
        \addplot[mark=o,      Dark2-4,    semithick                              ] table [x=Eb/N0, y=BER] {./dat/BCH_N511_K475_algebraic_T4.txt}; \label{plot:line1}
        \addplot[mark=o,      Dark2-4!90, semithick, dashed, mark options={solid}] table [x=Eb/N0, y=FER] {./dat/BCH_N511_K475_algebraic_T4.txt}; \label{plot:line2}
        \addplot[mark=square, Dark2-1,    semithick                              ] table [x=Eb/N0, y=BER] {./dat/RS_N255_K237_algebraic_T9.txt};  \label{plot:line3}
        \addplot[mark=square, Dark2-1!90, semithick, dashed, mark options={solid}] table [x=Eb/N0, y=FER] {./dat/RS_N255_K237_algebraic_T9.txt};  \label{plot:line4}
