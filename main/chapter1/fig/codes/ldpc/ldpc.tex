...
\begin{document}
  ...
  \node[draw=black, circle, minimum height=0.6cm, text=black] (v1) at (0.0, 2.0) {\small{1}};
  \node[draw=black, circle, minimum height=0.6cm, text=black] (v2) at (1.0, 2.0) {\small{2}};
  \node[draw=black, circle, minimum height=0.6cm, text=black] (v3) at (2.0, 2.0) {\small{3}};
  \node[draw=black, circle, minimum height=0.6cm, text=black] (v4) at (3.0, 2.0) {\small{4}};
  \node[draw=black, circle, minimum height=0.6cm, text=black] (v5) at (4.0, 2.0) {\small{5}};
  \node[draw=black, circle, minimum height=0.6cm, text=black] (v6) at (5.0, 2.0) {\small{6}};
  \node[draw=black, circle, minimum height=0.6cm, text=black] (v7) at (6.0, 2.0) {\small{7}};
  \node[draw=black, circle, minimum height=0.6cm, text=black] (v8) at (7.0, 2.0) {\small{8}};
