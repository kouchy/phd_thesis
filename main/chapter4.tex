...
\emph{A15-J} and the ones from the Hardkernel\R ODROID-XU as the \emp{A15-O}.
...
\begin{figure}[htp]
  \centering
  \subfloat[][Simulator speedups.]{\includegraphics[width=1.00\textwidth]{\curChapter/fig/simu/speedup/speedup}\label{plot:simu_speedup}}
  % \quad
  \\
  \subfloat[][Simulator throughputs.]{\includegraphics[width=0.70\textwidth]{\curChapter/fig/simu/throughput/throughput}\label{plot:simu_throughput}}
  \caption
