...
\begin{figure}[htp]
  \centering
  \subfloat[][Without compression]{\includegraphics[width=0.7\textwidth]{\curChapter/fig/polar/sc_gen_l1i_size/sc_gen_l1i_size_wo_comp}\label{plot:eval_polar_sc_gen_l1i_size_wo_comp}}
  % \quad
  \\
  \subfloat[][With compression]{\includegraphics[width=0.7\textwidth]{\curChapter/fig/polar/sc_gen_l1i_size/sc_gen_l1i_size_w_comp}\label{plot:eval_polar_sc_gen_l1i_size_w_comp}}
...
\begin{figure}[htp]
  \centering
  \subfloat[][Intel\R Xeon\TM E31225 (SSE4.1 SIMD)]{\includegraphics[width=0.485\textwidth]{\curChapter/fig/polar/sc_gen_thr_intra/sc_gen_thr_intra_x86}\label{plot:eval_polar_sc_gen_thr_intra_x86}}
  \quad
  % \\
...
\begin{figure}[htp]
  \centering
  \subfloat[][Intel\R Xeon\TM E31225 (SSE4.1 SIMD)]{\includegraphics[width=0.7\textwidth]{\curChapter/fig/polar/sc_gen_thr_inter/sc_gen_thr_inter_x86}\label{plot:eval_polar_sc_gen_thr_inter_x86}}
  % \quad
  \\
  \subfloat[][Nvidia\R Jetson TK1 A15 (NEON SIMD)]{\includegraphics[width=0.7\textwidth]{\curChapter/fig/polar/sc_gen_thr_inter/sc_gen_thr_inter_arm}\label{plot:eval_polar_sc_gen_thr_inter_arm}}
  \caption
...
\begin{table}[htp]
  ...
  \begin{tabular}{c | c c c}
    ...
    \hline
    \multirow{4}{*}{\textbf{\bigARM}} &       4xCortex-A15 MPCore &     2xCortex-A57 MPCore &  4 cores (with SMT) \\
...
the A7 and the A57 consumes less energy than the A15, respectively. This can be
...
\begin{figure}[htp]
  \centering
  \subfloat[][ARM\R Cortex-A7]{\includegraphics[width=0.485\textwidth]{\curChapter/fig/polar/sc_energy_freq/sc_energy_freq_a7}\label{plot:eval_polar_sc_energy_freq_a7}}
  \quad
  % \\
  \subfloat[][ARM\R Cortex-A15]{\includegraphics[width=0.485\textwidth]{\curChapter/fig/polar/sc_energy_freq/sc_energy_freq_a15}\label{plot:eval_polar_sc_energy_freq_a15}}
  \caption
...
350MHz. On the A15 \bigARM cluster, the energy cost is mainly driven by the CPU
...
available on the A15). The \little A7 is more energy efficient than the \bigARM
...
\begin{figure}[htp]
  \centering
  \subfloat[][Throughput.]{\includegraphics[width=0.7\textwidth]{\curChapter/fig/ldpc/WiMAX_thr_lat/WiMAX_thr}\label{plot:eval_ldpc_WiMAX_thr}}
  % \quad
  \\
  \subfloat[][Latency.]{\includegraphics[width=0.7\textwidth]{\curChapter/fig/ldpc/WiMAX_thr_lat/WiMAX_lat}\label{plot:eval_ldpc_WiMAX_lat}}
  \caption
...
\begin{figure}[htp]
  \centering
  \subfloat[][Throughput.]{\includegraphics[width=0.7\textwidth]{\curChapter/fig/ldpc/DVB-S2_thr_lat/DVB-S2_thr}\label{plot:eval_ldpc_DVB-S2_thr}}
  % \quad
  \\
  \subfloat[][Latency.]{\includegraphics[width=0.7\textwidth]{\curChapter/fig/ldpc/DVB-S2_thr_lat/DVB-S2_lat}\label{plot:eval_ldpc_DVB-S2_lat}}
  \caption
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=0.70\linewidth]{\curChapter/fig/scma/energy/energy}
  \caption
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=1.00\linewidth]{\curChapter/fig/scma/profiling/profiling}
  \caption
...
logarithms in \eqref{eq:ctx_scma_11}, exponentials in \eqref{eq:ctx_scma_7},
complex norm and complex subtraction in \eqref{eq:ctx_scma_5} and messages
passed from resources to users in \eqref{eq:ctx_scma_8}.
...
comparison operations embedded in the $\max(.)$ function in
\eqref{eq:ctx_scma_13}. Nevertheless, without using fast math libraries, log-MPA
