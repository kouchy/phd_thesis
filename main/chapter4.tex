...
higher throughputs.
% The MPA decoding algorithm exhibits its best performance on this platform when
% cross compiled using \verb|-O2 -mmic| flags by an Intel\R ICPC compiler. Using
% fast math options such as \verb|-no-prec-div| \verb|-no-prec-sqrt|
