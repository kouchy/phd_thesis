...
comes with a limited inherent parallelism of 8 (corresponding to the 8 trellis
...
% Section~\ref{sec:opt_vec_intra}) to take advantage of the algorithms inherent
