...
In some works the decoding algorithm is capable of \emph{early termination}
(Early T.). This mean that the decoding process can stop before making all the
decoding iterations if some criterion is reached. This lead to increased
\emph{average} decoding performances. To be as fair as possible we decided to
report \emph{worst} decoding performances in the HoFs.
