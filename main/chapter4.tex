...
support many variants. Moreover, each of the presented implementations are able
to work close to the reference decoding performance.
...
These HoFs allows to compare CPU and GPU implementations. Some metrics like the
...
decoding algorithm. As a consequence, in general, the CPUs are more adapted to
