...
\begin{table}[htp]
  ...
  \toprule
              & Platinum 8168                 & EPYC 7452            \\
  \midrule
  CPU         & Intel\R Xeon\TM Platinum 8168 & AMD\R EPYC 7452      \\
  Arch.       & \textit{Skylake} Q3'17        & \textit{Zen 2} Q3'19 \\
  Process     & 14 nm                         & 7 nm                 \\
  Cores/Freq. & 24 cores, 2.7 GHz             & 32 cores, 2.35 GHz   \\
  LLC         & 33 MB L3                      & 128 MB L3            \\
  TDP         & 205 W                         & 155 W                \\
  \bottomrule
  \end{tabular}
...
\begin{figure}[htp]
  \centering
  \subfloat[][Throughput.]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/ldpc/WiMAX_thr_lat/WiMAX_thr}}\label{plot:eval_ldpc_WiMAX_thr}}
  \quad
  \subfloat[][Latency.]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/ldpc/WiMAX_thr_lat/WiMAX_lat}}\label{plot:eval_ldpc_WiMAX_lat}}
  \caption
...
\begin{figure}[htp]
  \centering
  \subfloat[][Throughput.]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/ldpc/DVB-S2_thr_lat/DVB-S2_thr}}\label{plot:eval_ldpc_DVB-S2_thr}}
  \quad
  \subfloat[][Latency.]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/ldpc/DVB-S2_thr_lat/DVB-S2_lat}}\label{plot:eval_ldpc_DVB-S2_lat}}
  \caption
...
\begin{table}[htp]
  ...
  \toprule
       &                  &          &       &   Pre. &     & Up.   & $\mathcal{L}$ & $\mathcal{T}_c$ & $\mathcal{NT}_c$ \\
  Ref. & Standard $(N,K)$ & Platform & Cores & (bits) & $i$ & Rules &      ($\mu$s) &          (Mb/s) &           (Mb/s) \\
  \midrule         %              Standard   Platform     Cores  Pre     i  Alg.      L     Tc     NTc
...
\begin{table}[htp]
  ...
  \begin{tabular}{c | c c c}
  \toprule
              & E3-1225                 & i7-2600                 & i7-4850HQ                  \\
  \midrule
  CPU         & Intel\R Xeon\TM E3-1225 & Intel\R Core\TM i7-2600 & Intel\R Core\TM  i7-4850HQ \\
  Cores/Freq. & 4 cores, 3.1-3.4 Ghz    & 4 cores, 3.4-3.8 GHz    & 4 cores, 2.3-3.5 GHz       \\
  Arch.       & \emph{Sandy Bridge}     & \emph{Sandy Bridge}     & \emph{Crystal Well}        \\
  Process     & 32 nm                   & 32 nm                   & 22 nm                      \\
  LLC         & L3 6 MB                 & L3 8 MB                 & L3 6 MB                    \\
  \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[htp]
  ...
  \begin{tabular}{c | c c c}
  \toprule
                                  &                A15-J &             A15-O/A7-O &                A57/A53 \\
  \midrule
  SoC                             &  Nvidia\R Jetson TK1 & Hardkernel\R ODROID-XU &            ARM\R \juno \\
  Arch.                           & 32-bit, \emph{ARMv7} &   32-bit, \emph{ARMv7} &   64-bit, \emph{ARMv8} \\
% Process                         &                28 nm &                  28 nm & unspecified (32/28 nm) \\
  \addlinespace
  \multirow{3}{*}{\text{\bigARM}} &  4xCortex-A15 MPCore &    4xCortex-A15 MPCore &    2xCortex-A57 MPCore \\
                                  &       freq. 2.32 Ghz &     freq. 0.8--1.6 GHz &    freq. 0.45--1.1 GHz \\
                                  &              L2 1 MB &                L2 2 MB &                L2 2 MB \\
  \addlinespace
  \multirow{3}{*}{\text{\little}} &  \multirow{3}{*}{--} &     4xCortex-A7 MPCore &    4xCortex-A53 MPCore \\
...
\begin{table}[htp]
  ...
  \toprule
          & Freq. &       & $\mathcal{L}$ & $\mathcal{T}_i$ & $P$ & $E_b$ \\
  Cluster & (MHz) & Impl. &     ($\mu$s)  &          (Mb/s) & (W) &  (nJ) \\
  \midrule                   %                 Freq.   Impl.        L      Ti       P      Eb
...
\begin{figure}[htp]
  \centering
  \subfloat[][Total (cluster + memory).]{\resizebox{!}{7cm}{\inputtikz{\curChapter/fig/polar/sc_energy_implems_vs/sc_energy_implems_vs_total}}\label{plot:eval_polar_sc_energy_implems_vs_total}}
  \quad
  \subfloat[][Memory only.]{\resizebox{!}{7cm}{\inputtikz{\curChapter/fig/polar/sc_energy_implems_vs/sc_energy_implems_vs_mem}}\label{plot:eval_polar_sc_energy_implems_vs_mem}}
  \caption
...
\begin{figure}[htp]
  \centering
  \subfloat[][ARM\R Cortex-A7 (ODROID-XU+E)]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_energy_freq/sc_energy_freq_a7}}\label{plot:eval_polar_sc_energy_freq_a7}}
  \quad
  \subfloat[][ARM\R Cortex-A15 (ODROID-XU+E)]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_energy_freq/sc_energy_freq_a15}}\label{plot:eval_polar_sc_energy_freq_a15}}
  \caption
...
\begin{figure}[htp]
  \centering
  \resizebox{0.70\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_energy_rate/sc_energy_rate_N32768}}
  \caption
...
\begin{figure}[htp]
  \centering
  \resizebox{0.7\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_colgate/sc_colgate}}
  \caption
...
\begin{table}[htp]
  ...
  \begin{tabular}{r r r r r r r}
  \toprule
  Generated Decoder & $N = 2^6$ & $N = 2^8$ & $N = 2^{10}$ & $N = 2^{12}$ & $N = 2^{14}$ & $N = 2^{16}$ \\
  \midrule                %   2^6      2^8              2^10               2^12                2^14                          2^16
...
\begin{figure}[htp]
  \centering
  \subfloat[][Without compression]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_gen_l1i_size/sc_gen_l1i_size_wo_comp}}\label{plot:eval_polar_sc_gen_l1i_size_wo_comp}}
  \quad
  \subfloat[][With compression]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_gen_l1i_size/sc_gen_l1i_size_w_comp}}\label{plot:eval_polar_sc_gen_l1i_size_w_comp}}
  \caption
...
\begin{table}[htp]
  ...
  \toprule
                       &           & Freq. &        & $\mathcal{L}$ & $\mathcal{T}_i$ \\
  Ref.                 &  Platform & (GHz) &   SIMD &      ($\mu$s) &          (Mb/s) \\
  \midrule
...
\begin{figure}[htp]
  \centering
  \subfloat[][Intel\R Xeon\TM E3-1225 (AVX SIMD)]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_gen_thr_intra/sc_gen_thr_intra_x86}}\label{plot:eval_polar_sc_gen_thr_intra_x86}}
  \quad
  \subfloat[][Nvidia\R Jetson TK1 A15 (NEON SIMD)]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_gen_thr_intra/sc_gen_thr_intra_arm}}\label{plot:eval_polar_sc_gen_thr_intra_arm}}
  \caption
...
\begin{table}[htp]
  ...
  \caption
    ...
    {Comparing SC with a state-of-art generated software polar decoder, for
     different code sizes, using intra-frame SIMD.
     %The two cross marks show state-of-the art performance results reported
     %in~\cite{Sarkis2014}, for comparison.
     The AVX SIMD instructions are applied.}
  \label{tab:eval_polar_sc_gen_thr_comparison}
  \begin{tabular}{r r r r r}
  \toprule
       &          &          & $\mathcal{L}$ & $\mathcal{T}_i$ \\
  Ref. & $(N, K)$ & Platform &      ($\mu$s) &          (Mb/s) \\
  \midrule             %                          (N, K)  Platform     L    Ti
...
\begin{figure}[htp]
  \centering
  \subfloat[][Intel\R Xeon\TM E3-1225 (SSE4.1 SIMD)]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_gen_thr_inter/sc_gen_thr_inter_x86}}\label{plot:eval_polar_sc_gen_thr_inter_x86}}
  \quad
  \subfloat[][Nvidia\R Jetson TK1 A15 (NEON SIMD)]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/polar/sc_gen_thr_inter/sc_gen_thr_inter_arm}}\label{plot:eval_polar_sc_gen_thr_inter_arm}}
  \caption
...
\begin{table}[htp]
  ...
  \toprule
  & & $\mathcal{L}_\text{worst}$ & \multicolumn{2}{c}{3.5 dB} & \multicolumn{2}{c}{4.0 dB} & \multicolumn{2}{c}{4.5 dB} \\
  \cmidrule(lr){4-5} \cmidrule(lr){6-7} \cmidrule(lr){8-9}
  Decoder & Prec. & ($\mu$s) & $\mathcal{L}_\text{avg}$ & $\mathcal{T}_i$ & $\mathcal{L}_\text{avg}$ & $\mathcal{T}_i$ & $\mathcal{L}_\text{avg}$ & $\mathcal{T}_i$ \\
  \midrule                 %  Prec.     Lw   La3.5  Ti3.5  La4.0   Ti4.0 La4.5   Ti4.5
...
\begin{table}[htp]
  ...
  \begin{tabular}{r r r r r r r}
  \toprule
  & & & $\mathcal{L}_\text{worst}$ & \multicolumn{3}{c}{$\mathcal{T}_i$ (Mb/s)} \\
  \cmidrule(lr){5-7}
  Ref. & Target & Decoder & ($\mu s$) & 3.5 dB & 4.0 dB & 4.5 dB \\
  \midrule                              %                   Target    Decoder               Lw   Ti3.5   Ti4.0    Ti4.5
  ...
  \addlinespace
% original data
% \multirow{4}{*}{\cite{Leonardon2019}} & \multirow{4}{*}{E5-2650}  & CA-SCL  &           6554 &  0.27 &   0.2 &   0.27 \\
%                                       &                           & CA-SSCL &           1048 &  1.67 &   1.6 &   1.67 \\
%                                       &                           & PA-SSCL & $\approx$ 1048 &  4.07 &  22.9 & 124.10 \\
%                                       &                           & FA-SSCL & $\approx$ 2096 & 14.30 & 109.8 & 180.00 \\
% \addlinespace
% rescaled data from E5-2650
  \multirow{4}{*}{\cite{Leonardon2019}} & \multirow{4}{*}{i7-2600}  & CA-SCL  &           4819 &  0.37 &   0.3 &   0.37 \\
                                        &                           & CA-SSCL &            770 &  2.30 &   2.3 &   2.30 \\
                                        &                           & PA-SSCL &            847 &  5.50 &  31.1 & 168.40 \\
                                        &                           & FA-SSCL &           1602 & 19.40 & 149.0 & 244.30 \\
  \addlinespace
  \multirow{4}{*}{\cite{Leonardon2019}} & \multirow{4}{*}{i5-6600K} & CA-SCL  &           3635 &  0.48 &   0.4 &   0.48 \\
                                        &                           & CA-SSCL &            577 &  3.00 &   3.0 &   3.00 \\
                                        &                           & PA-SSCL &            635 &  7.60 &  42.1 & 237.60 \\
                                        &                           & FA-SSCL &           1201 & 26.10 & 207.8 & 345.50 \\
  \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[htp]
  ...
  \midrule
  CPU         & Intel\R Xeon\TM E5-2650   & Intel\R Core\TM i7-4960HQ & Intel\R Xeon\TM E5-2680 v3 \\
  Cores/Freq. & 8 cores, 2--2.8 GHz       & 4 cores, 2.6--3.8 GHz     & 12 cores,  2.5--3.3 GHz    \\
  Arch.       & \textit{Ivy Bridge} Q1'12 & \textit{Haswell} Q4'13    & \textit{Haswell} Q3'14     \\
  LLC         & 20 MB L3                  & 6 MB L3                   & 30 MB L3                   \\
  TDP         & 95 W                      & 47 W                      & 120 W                      \\
  \bottomrule
  \end{tabular}
  }}
...
\begin{figure}[htp]
  \centering
  \resizebox{0.90\textwidth}{!}{\inputtikz{\curChapter/fig/turbo/thr/thr}}
  \caption
...
\begin{figure}[htp]
  \centering
  \resizebox{0.7\textwidth}{!}{\inputtikz{\curChapter/fig/turbo/energy/energy}}
  \caption
...
not so clear on larger codewords ($K=6144$) since with 3/4 cores, SSE
outperforms the AVX version.
...
\begin{table}[htp]
  ...
  \toprule
  & & & SIMD & Pre. & Inter & & BER & FER & $\mathcal{L}$ & $\mathcal{T}_i$ & $\mathcal{NT}_i$ \\
  Ref. & Platform & Cores & (length) & (bit) & (level) & $i$ & \multicolumn{2}{c}{(at 0.7 dB)} & ($\mu$s) & (Mb/s) & (Mb/s) \\
  \midrule             % Platform           Cores SIMD Pre. Inter   i     BER     FER      L       Ti     NTi
...
\begin{table}[htp]
  ...
  \toprule
              & i7-6700HQ                 & 7120P                         & A57                   \\
  \midrule
  CPU         & Intel\R Core\TM i7-6700HQ & Intel\R Xeon Phi\TM 7120P     & ARM\R Cortex-A57      \\
              &                           &                               & (Nvidia\R Jetson TX1) \\
  Cores/Freq. & 4 cores, 2.6--3.5 GHz     & 64 cores,  1.24--1.33 GHz     & 4 cores, 1.91 GHz     \\
  Arch.       & \textit{Ivy Bridge} Q1'12 & \textit{Knights Corner} Q2'13 & \textit{ARMv8} Q1'15  \\
  LLC         & 6 MB L3                   & 30.5 MB L2                    & 2 MB L2               \\
  TDP         & 45 W                      & 300 W                         & 15 W                  \\
  \bottomrule
  \end{tabular}
  }}
...
\begin{table}[htp]
  ...
  \begin{tabular}{r | r r r r r r}
  \toprule
  & Algorithm & Optim. & $\mathcal{L}$ & $\mathcal{T}$ & $P$ & $E_b$    \\
  & \& SIMD   & Level  & (s)           & (Mb/s)        & (W) & ($\mu$J) \\
  \midrule
  \multirow{6}{*}{\rotatebox[origin=c]{90}{i7-6700HQ}}
  ...
  \addlinespace
  \multirow{4}{*}{\rotatebox[origin=c]{90}{7120P}}
  ...
  \addlinespace
  \multirow{6}{*}{\rotatebox[origin=c]{90}{A57}}
  %  Algorithm &           Optim & Latency & T. per Socket &  Power & Energy per Bit \\
...
\begin{figure}[htp]
  \centering
  \resizebox{1.0\textwidth}{!}{\inputtikz{\curChapter/fig/simu/chain/chain}}
  \caption
...
\begin{table}[htp]
  ...
  \toprule
  & & \multicolumn{2}{c}{SIMD instr.} &            & \# Cores  & Freq. &     & Turbo \\
  \cmidrule(lr){3-4}
  \multicolumn{2}{c}{CPU} & Name & Size & \# Proc. & per Proc. & (GHz) & SMT & Boost \\
  \midrule % CPU                 SIMD      SIMD size CPU Cores  Freq SMT    Boost
...
\begin{table}[htp]
  ...
  \midrule
  \multirow{6}{*}{\rotatebox[origin=c]{90}{$\mathcal{T}$ (Mb/s)}}
...
% &     EPYC\TM 7452       &         217.5  &        14443.7  &         9096.3  &        357.9  &         28365.2  &       13571.1  &         115.8 \\
  ...
  \addlinespace
  \multirow{6}{*}{\rotatebox[origin=c]{90}{$\mathcal{L}$ ($\mu$s)}}
...
\begin{figure}[htp]
  \centering
  \subfloat[][Simulator speedups.]{\resizebox{1.0\textwidth}{!}{\inputtikz{\curChapter/fig/simu/speedup/speedup}}\label{plot:eval_simu_speedup}}
  \\
  \subfloat[][Simulator throughputs.]{\resizebox{0.7\textwidth}{!}{\inputtikz{\curChapter/fig/simu/throughput/throughput}}\label{plot:eval_simu_throughput}}
  \caption
