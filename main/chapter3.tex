...
\begin{figure}[htp]
  \centering
  \includegraphics[width=1.00\textwidth]{vectorization/mandelbrot_speedup/mandelbrot_speedup}
...
\caption{Throughput of the SC decoder depending on the different optimizations
  for $N = 2048$, for intra-frame vectorization on the left and inter-frame
...
\begin{figure}[htp]
  \centering
  \subfloat[][Without compression.]{\includegraphics[height=7.5cm]{polar/sc_gen_compression/sc_gen_no_compression}\label{fig:eval_polar_sc_gen_compression_wo}}
  % \qquad
  \\
  \subfloat[][With compression.]{\includegraphics[height=7.5cm]{polar/sc_gen_compression/sc_gen_compression}\label{fig:eval_polar_sc_gen_compression_w}}
...
the heavily unrolled generated decoders exceed Level 1 instruction cache size
capacity.
