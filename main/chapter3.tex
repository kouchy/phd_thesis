...
\begin{figure}[htp]
  ...
  {
    \includegraphics[scale=0.9]{scma/simd_norm/simd_norm_aos_mipp}
    \label{fig:opt_scma_simd_norm_aos}
  }
  \\
  \subfloat[][Structure of Arrays (SoA)]
  {
    \includegraphics[scale=0.9]{scma/simd_norm/simd_norm_soa_mipp}
...
\begin{figure}[htp]
  \centering
  \includegraphics[scale=0.9]{scma/simd_exp/simd_exp_mipp}
  \caption
...
\begin{figure}[htp]
  \centering
  \includegraphics[scale=0.9]{scma/simd_final_beliefs/simd_final_beliefs_mipp}
  \caption
