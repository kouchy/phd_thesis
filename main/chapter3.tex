...
\begin{figure}[htp]
  \centering
  \input{main/chapter3/fig/vectorization/inter_frame/inter_frame}
  \caption
...
\begin{figure}[htp]
  \centering
  \input{main/chapter3/fig/polar/patterns/patterns}
...
\begin{figure}[htp]
  \centering
  \input{main/chapter3/fig/polar/sc_gen_compression/sc_gen_compression_styles}
  \subfloat[][Legend.]{
    \input{main/chapter3/fig/polar/sc_gen_compression/sc_gen_compression_legend}
  }
  \\
  \subfloat[][Without compression.]{
    \label{fig:eval_polar_sc_gen_compression_wo}
    \input{main/chapter3/fig/polar/sc_gen_compression/sc_gen_no_compression}
  }
  \\
  \subfloat[][With compression.]{
    \label{fig:eval_polar_sc_gen_compression_w}
    \input{main/chapter3/fig/polar/sc_gen_compression/sc_gen_compression}
  }
  \caption
...
\begin{figure}[htp]
  ...
  \subfloat[][Array of Structures (AoS).]{
    ...
    \input{main/chapter3/fig/scma/simd_norm/simd_norm_aos}
  }
  \\
  \subfloat[][Structure of Arrays (SoA).]{
    \label{fig:scma_simd_norm_soa}
    \input{main/chapter3/fig/scma/simd_norm/simd_norm_soa}
  }
  \caption
...
\begin{figure}[htp]
  ...
  \subfloat[][Vectorized Exponentials ($N_0 = 2\sigma^2$)]{
    ...
    \input{main/chapter3/fig/scma/simd_exp_mul/simd_exp}
  }
  \\
  \subfloat[][Vectorized calculation of final guess at user 4.]{
    \label{fig:scma_simd_final_guess}
    \input{main/chapter3/fig/scma/simd_exp_mul/simd_final_guess}
  }
  \caption
