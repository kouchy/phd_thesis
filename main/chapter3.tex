...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}[baseline]
    ...
    \node[draw=black, dotted                     , minimum width=0.8cm, minimum height=0.4cm, label={[black]right:\footnotesize{Global memory}}   ] (ram)   at (0.1, -1.1-3) {};
    \node[draw=black,                            , minimum width=0.8cm, minimum height=0.4cm, label={[black]right:\footnotesize{SIMD register}}   ] (simdr) at (0.1, -1.7-3) {};
    \node[draw=black,         rounded corners=3pt, minimum width=0.8cm, minimum height=0.4cm, label={[black]right:\footnotesize{SIMD instruction}}] (simdi) at (0.1, -2.3-3) {};
    \node[draw=black, dashed, rounded corners=3pt, minimum width=0.8cm, minimum height=0.4cm, label={[black]right:\footnotesize{SIMD function}}   ] (simdm) at (0.1, -2.9-3) {};

    \node[fill=Paired-5!40, minimum width=0.8cm, minimum height=0.4cm, label={[black]left:\footnotesize{Complex norm $d_x$}}] (cr) at (\rth+0.7+4.10, -1.1-3) {};
    \node[fill=gray!40    , minimum width=0.8cm, minimum height=0.4cm, label={[black]left:\footnotesize{Noise $n_x = -N_0$}}] (ci) at (\rth+0.7+4.10, -1.7-3) {};
    \node[fill=Paired-7!40, minimum width=0.8cm, minimum height=0.4cm, label={[black]left:\footnotesize{Probability $P_x$}} ] (cn) at (\rth+0.7+4.10, -2.3-3) {};
    ...
    \node[intr] (intr0) at (\lft+2.45, -\vs+1) {\footnotesize{\texttt{\_mm256\_loadu\_ps}}};
    \draw[lnk] (7.35,-0.35) |- (intr0.east);
    \draw[lnk] (intr0.south) -- (2.45,-\vs+0.35);
    ...
    \node[intr] (intr1) at (\rth+2.45, -\vs+1) {\footnotesize{\texttt{\_mm256\_set1\_ps(}$-N_0$\texttt{)}}};
    \draw[lnk] (intr1.south) -- (\rth+2.45,-\vs+0.35);
    ...
    \node[intr] (intr2) at (\ctr+2.45, -\vs-\vs+1) {\footnotesize{\texttt{\_mm256\_div\_ps}}};

    \draw[lnk] (r0_e4.south west) |- (intr2.west);
    \draw[lnk] (r1_e3.south east) |- (intr2.east);
    ...
    \node[intr, dashed] (intr3) at (\ctr+2.45, -\vs-\vs-\vs+1) {\footnotesize{MIPP exponential (\texttt{mipp::exp})}};
    ...
    \node[intr] (intr4) at (\ctr+2.45, -\vs-\vs-\vs-\vs+1) {\footnotesize{\texttt{\_mm256\_storeu\_ps}}};
  ...
  \begin{tikzpicture}[baseline]
    \tikzset{ e/.style   ={draw=black, minimum width=0.7cm, minimum height=0.7cm, text=black, preaction={fill=gray!40}                  } }
    \tikzset{ es/.style  ={draw=black, minimum width=0.7cm, minimum height=0.7cm, text=black, preaction={fill=gray!20}                  } }
    \tikzset{ en/.style  ={draw=black, minimum width=0.7cm, minimum height=0.7cm, text=black, preaction={fill=Paired-9!40}              } }
    \tikzset{ enn/.style ={draw=black, minimum width=0.7cm, minimum height=0.7cm, text=black, preaction={fill=Paired-11!40!Paired-9!40} } }
    \tikzset{ ens/.style ={draw=black, minimum width=0.7cm, minimum height=0.7cm, text=black, preaction={fill=Paired-6!40}              } }
    \tikzset{ ep/.style  ={draw=black, minimum width=0.7cm, minimum height=0.7cm, text=black, preaction={fill=Paired-11!40}             } }
    \tikzset{ eps/.style ={draw=black, minimum width=0.7cm, minimum height=0.7cm, text=black, preaction={fill=Paired-8!40}              } }
    \tikzset{ ept/.style={            minimum width=0.7cm, minimum height=0.7cm] } }
    ...
    \node[fill=Paired-9!40             , minimum width=0.8cm, minimum height=0.4cm, label={[black]left:\footnotesize{Msg. from $RES2$ to $UE4$}}] (cr) at (\rth+0.7+4.10, -1.1-2.7) {};
    \node[fill=Paired-11!40            , minimum width=0.8cm, minimum height=0.4cm, label={[black]left:\footnotesize{Msg. from $RES4$ to $UE4$}}] (ci) at (\rth+0.7+4.10, -1.7-2.7) {};
    \node[fill=Paired-11!40!Paired-9!40, minimum width=0.8cm, minimum height=0.4cm, label={[black]left:\footnotesize{Guess at $UE4$}}           ] (cn) at (\rth+0.7+4.10, -2.3-2.7) {};

    \node[ept        ] (mi_e0)  at ( 0.0, 0.00) {\tiny{...}};
    \node[en , dotted] (mi_e1)  at ( 1.4, 0.00) {};
    \node[en , dotted] (mi_e2)  at ( 2.1, 0.00) {};
    \node[en , dotted] (mi_e3)  at ( 2.8, 0.00) {};
    \node[en , dotted] (mi_e4)  at ( 3.5, 0.00) {};
    \node[ept        ] (mi_e5)  at ( 4.9, 0.00) {\tiny{...}};
    \node[es,  dotted] (mi_e6)  at ( 6.3, 0.00) {};
    \node[es,  dotted] (mi_e7)  at ( 7.0, 0.00) {};
    \node[es,  dotted] (mi_e8)  at ( 7.7, 0.00) {};
    \node[es,  dotted] (mi_e9)  at ( 8.4, 0.00) {};
    \node[ept        ] (mi_e10) at ( 9.8, 0.00) {\tiny{...}};
    \node[ep , dotted] (mi_e11) at (11.2, 0.00) {};
    \node[ep , dotted] (mi_e12) at (11.9, 0.00) {};
    \node[ep , dotted] (mi_e13) at (12.6, 0.00) {};
    \node[ep , dotted] (mi_e14) at (13.3, 0.00) {};
    \node[ept        ] (mi_e15) at (14.7, 0.00) {\tiny{...}};

    \node[en] (r0_e0) at (\lft+1.4, -\vs) {\tiny{$m_1^2$}};
    \node[en] (r0_e1) at (\lft+2.1, -\vs) {\tiny{$m_2^2$}};
    \node[en] (r0_e2) at (\lft+2.8, -\vs) {\tiny{$m_3^2$}};
    \node[en] (r0_e3) at (\lft+3.5, -\vs) {\tiny{$m_4^2$}};

    \node[intr] (intr0) at (\lft+2.45, -\vs+1) {\footnotesize{\texttt{\_mm\_loadu\_ps}}};
    \draw[lnk] (2.45,-0.35) -- (intr0.north);
    \draw[lnk] (intr0.south) -- (2.45,-\vs+0.35);

    \node[ep] (r1_e0) at (\rth+1.4, -\vs) {\tiny{$m_1^4$}};
    \node[ep] (r1_e1) at (\rth+2.1, -\vs) {\tiny{$m_2^4$}};
    \node[ep] (r1_e2) at (\rth+2.8, -\vs) {\tiny{$m_3^4$}};
    \node[ep] (r1_e3) at (\rth+3.5, -\vs) {\tiny{$m_4^4$}};

    \node[intr] (intr1) at (\rth+2.45, -\vs+1) {\footnotesize{\texttt{\_mm\_loadu\_ps}}};
    \draw[lnk] (\rth+2.45,-0.35) -- (intr1.north);
    \draw[lnk] (intr1.south) -- (\rth+2.45,-\vs+0.35);

    \node[enn] (r2_e0) at (\ctr+1.4, -\vs-\vs) {\tiny{$g_1^4$}};
    \node[enn] (r2_e1) at (\ctr+2.1, -\vs-\vs) {\tiny{$g_2^4$}};
    \node[enn] (r2_e2) at (\ctr+2.8, -\vs-\vs) {\tiny{$g_3^4$}};
    \node[enn] (r2_e3) at (\ctr+3.5, -\vs-\vs) {\tiny{$g_4^4$}};
    ...
    \node[intr] (intr2) at (\ctr+2.45, -\vs-\vs+1) {\footnotesize{\texttt{\_mm\_mul\_ps}}};

    \draw[lnk] (r0_e2.south west) |- (intr2.west);
    \draw[lnk] (r1_e1.south east) |- (intr2.east);
    \draw[lnk] (intr2.south)      -- (7.35,-\vs-\vs+0.35);

    \node[intr] (intr3) at (\ctr+2.45, -\vs-\vs-\vs+1) {\footnotesize{\texttt{\_mm\_storeu\_ps}}};

    \draw[lnk] (7.35, -\vs-\vs-0.35) -- (intr3);
    \draw[lnk] (intr3) -- (7.35,-\vs-\vs-\vs+0.35);

    \node[ept        ] (mo_er0)  at ( 0.0, -\vs-\vs-\vs-0.00) {\tiny{...}};
    \node[es , dotted] (mo_er1)  at ( 0.7, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er2)  at ( 1.4, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er3)  at ( 2.1, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er4)  at ( 2.8, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er5)  at ( 3.5, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er6)  at ( 4.2, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er7)  at ( 4.9, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er8)  at ( 5.6, -\vs-\vs-\vs-0.00) {};
    \node[enn, dotted] (mo_er9)  at ( 6.3, -\vs-\vs-\vs-0.00) {};
    \node[enn, dotted] (mo_er10) at ( 7.0, -\vs-\vs-\vs-0.00) {};
    \node[enn, dotted] (mo_er11) at ( 7.7, -\vs-\vs-\vs-0.00) {};
    \node[enn, dotted] (mo_er12) at ( 8.4, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er13) at ( 9.1, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er14) at ( 9.8, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er15) at (10.5, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er16) at (11.2, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er17) at (11.9, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er18) at (12.6, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er19) at (13.3, -\vs-\vs-\vs-0.00) {};
    \node[es , dotted] (mo_er20) at (14.0, -\vs-\vs-\vs-0.00) {};
    ...
    \draw[<->,>=latex,black] (-0.35, -6.75) -- (15.05, -6.75) node (arrow2) [midway, text=black, fill=white] {\small{Final guesses}};
