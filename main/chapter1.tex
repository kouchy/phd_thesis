...
\begin{figure}[htp]
  \centering
  \includegraphics[scale=1.0]{intro/com_chain/com_chain}
...
will focuses on a subset of these codes, namely the LDPC codes, the turbo codes
and the polar codes. These codes have been selected because they are known to
...
\begin{figure}[htp]
  \centering
  \subfloat[][LDPC code ($R = 5/6$).                ]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_ldpc}  \label{fig:intro_bfer_ldpc}}   \quad{}
  \subfloat[][Turbo code ($R \approx 1/3$).         ]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_turbo} \label{fig:intro_bfer_turbo}}  \\
  \subfloat[][Polar code ($R \approx 0.84$).        ]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_polar} \label{fig:intro_bfer_polar}}  \quad{}
  \subfloat[][Turbo product code ($R \approx 0.78$).]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_tpc}   \label{fig:intro_bfer_tpc}}    \\
  \subfloat[][Algebraic codes ($R \approx 0.93$).   ]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_bch_rs}\label{fig:intro_bfer_bch_rs}} \quad{}
  \subfloat[][Convolutional codes ($R \approx 1/2)$.]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_rsc}   \label{fig:intro_bfer_rsc}}
  \caption
...
therefore fewer errors. For instance, in Fig.~\ref{fig:intro_bfer_ldpc}, on
...
purpose of Fig.~\ref{fig:intro_bfer} is not to compare the codes with each
...
by introducing a domain specific language for the SDR. The high performance
