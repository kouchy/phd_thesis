...
\begin{figure}[htp]
  \centering
  \subfloat[][LDPC code ($R = 5/6$).                ]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_ldpc}  \label{fig:ctx_bfer_ldpc}}   \quad{}
  \subfloat[][Turbo code ($R \approx 1/3$).         ]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_turbo} \label{fig:ctx_bfer_turbo}}  \\
  \subfloat[][Polar code ($R \approx 0.84$).        ]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_polar} \label{fig:ctx_bfer_polar}}  \quad{}
  \subfloat[][Turbo product code ($R \approx 0.78$).]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_tpc}   \label{fig:ctx_bfer_tpc}}    \\
  \subfloat[][Algebraic codes ($R \approx 0.93$).   ]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_bch_rs}\label{fig:ctx_bfer_bch_rs}} \quad{}
  \subfloat[][Convolutional codes ($R \approx 1/2)$.]{\includegraphics[width=0.475\textwidth]{simu/bfer/bfer_rsc}   \label{fig:ctx_bfer_rsc}}
  \caption
