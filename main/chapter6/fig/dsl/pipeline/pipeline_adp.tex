...
\begin{document}
  \begin{tikzpicture}%[scale=\tikzscale]
    ...
    \node[seq, label={[Paired-11]below:Sequence 1}, fit=(t1) (t1_so) (adp1n_push)  ] (seq1) {};
    \node[seq, label={[Paired-11]below:Sequence 2}, fit=(adp1n_pull1) (adpn1_push4)] (seq2) {};
    \node[seq, label={[Paired-11]below:Sequence 3}, fit=(adpn1_pull) (t5) (t6)     ] (seq3) {};
