...
\begin{document}
  \begin{tikzpicture}%[scale=\tikzscale]
    ...
    \draw[->,>=latex] (lp1) -- (ss2) node [midway, above, sloped] {0};
    \draw[->,>=latex] (lp1) -- (ss5) node [midway, above, sloped] {1};
    \draw[->,>=latex] (ss2) -- (lp2) node [midway, above, sloped] {};
    \draw[->,>=latex] (lp2) -- (ss3) node [midway, above, sloped] {0};
    \draw[->,>=latex] (lp2) -- (ss4) node [midway, above, sloped] {1};
