...
\begin{document}
  \begin{tikzpicture}%[scale=\tikzscale]
    ...
    \node[sout] (loop_so1) at (0+3,  1.0) {};
    \node[sout] (loop_so2) at (0+3, -1.0) {};

    \node[sin ] (loop_si1) at (0-3,  1.0) {};
    \node[sin ] (loop_si2) at (0-3,  0.5) {};
    \node[sin ] (loop_si3) at (0-3, -0.5) {};
    \node[sin ] (loop_si4) at (0-3, -1.0) {};
    ...
    \draw[->,>=latex] (t4_so.north east) |- (7,1.60) -- (-3.4,1.60) |- (loop_si2) node [midway, above] {};

    \draw[->,>=latex] (t5_so.east) -- (9.25,1) -- (9.25,1.70) -- (-3.6,1.70) |- (loop_si4) node [midway, above] {};
