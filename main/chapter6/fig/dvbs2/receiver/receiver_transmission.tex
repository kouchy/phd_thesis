...
\begin{document}
  \begin{tikzpicture}%[scale=\tikzscale]
    ...
    \node[stsk                     , align=center] (t1) at ( 0.0, 2.0) {~receive~~\\($t^{\text{Rxt}}_1$)};
    \node[tsk , right=2.00cm of t1 , align=center] (t2)                {~imultiply~~\\($t^{\text{Rxt}}_2$)};
    \node[stsk, right=1.00cm of t2 , align=center] (t3)                {~synchronize~~\\($t^{\text{Rxt}}_3$)};
    \node[stsk, right=1.00cm of t3 , align=center] (t4)                {~filter~~\\($t^{\text{Rxt}}_4$)};
    \node[stsk, below=3.50cm of t2 , align=center] (t5)                {~synchronize~~\\($t^{\text{Rxt}}_5$)};
    \node[stsk, right=2.00cm of t5 , align=center] (t6)                {~extract~~\\($t^{\text{Rxt}}_6$)};
    \node[tsk , right=1.00cm of t6 , align=center] (t7)                {~imultiply~~\\($t^{\text{Rxt}}_7$)};
    \node[stsk, right=1.00cm of t7 , align=center] (t8)                {~synchronize~~\\($t^{\text{Rxt}}_8$)};
    \node[tsk , below=3.50cm of t5 , align=center] (t9)                {~descramble~~\\($t^{\text{Rxt}}_9$)};
    \node[stsk, right=1.00cm of t9 , align=center] (t10)               {~synchronize~~\\($t^{\text{Rxt}}_{10}$)};
    \node[tsk , right=1.00cm of t10, align=center] (t11)               {~synchronize~~\\($t^{\text{Rxt}}_{11}$)};
    \node[tsk , right=3.00cm of t11, align=center] (t12)               {~remove~~\\($t^{\text{Rxt}}_{12}$)};
    \node[tsk , right=1.00cm of t12, align=center] (t13)               {~estimate~~\\($t^{\text{Rxt}}_{13}$)};
    \node[tsk , below=3.50cm of t9 , align=center] (t14)               {~demodulate~~\\($t^{\text{Rxt}}_{14}$)};
    \node[tsk , right=1.00cm of t14, align=center] (t15)               {~deinterleave~~\\($t^{\text{Rxt}}_{15}$)};
    \node[tsk , right=1.00cm of t15, align=center] (t16)               {~decode SIHO~~\\($t^{\text{Rxt}}_{16}$)};
    \node[tsk , right=1.00cm of t16, align=center] (t17)               {~decode HIHO~~\\($t^{\text{Rxt}}_{17}$)};
    \node[tsk , right=1.00cm of t17, align=center] (t18)               {~descramble~~\\($t^{\text{Rxt}}_{18}$)};
    \node[stsk, right=2.00cm of t18, align=center] (t19)               {~send~~\\($t^{\text{Rxt}}_{19}$)};
    ...
    \node[mdl, label={[Paired-3, align=center]above:Modem},                          fit=(t14) (t14_si) (t14_so)    ] (m13) {};
