...
\begin{document}
  \begin{tikzpicture}%[scale=\tikzscale]
    ...
    \node[stsk                     , align=center                                                                                                 ] (t1) at ( 0.0, 2.0) {~receive~~\\($t^{\text{Rxl}}_1$)};
    \node[tsk ,  right=1.00cm of t1, align=center                                                                                                 ] (t2)                {~imultiply~~\\($t^{\text{Rxl}}_2$)};
    \node[stsk,  right=1.00cm of t2, minimum width=8cm, minimum height=5cm, label={[Paired-1,yshift=0.75cm]below:synchronize ($t^{\text{Rxl}}_3$)}] (t3)                {};
    ...
    \node[stsk,  right=1.00cm of t3 , align=center                                                                                                ] (t4)                {~extract~~\\($t^{\text{Rxl}}_4$)};
    \node[tsk ,  right=1.00cm of t4 , align=center                                                                                                ] (t5)                {~imultiply~~\\($t^{\text{Rxl}}_5$)};
    \node[stsk,  right=1.00cm of t5 , align=center                                                                                                ] (t6)                {~synchronize~~\\($t^{\text{Rxl}}_6$)};
    ...
    \node[mdl, label={[Paired-3, align=center]above:Synchronizer\\Step MF},          fit=(t3)  (t3_si1) (t3_si2)  (t3_so1)] (m3)  {};
