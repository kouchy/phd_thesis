...
\begin{figure}[htp]
  \centering
  \subfloat[][Simple chain sequence.]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/dsl/sequence/sequence_chain}}\label{fig:sdr_dsl_sequence_chain}}
  \quad
  \subfloat[][Sequence with multiple first and last tasks.]{\resizebox{0.485\textwidth}{!}{\inputtikz{\curChapter/fig/dsl/sequence/sequence_generic}}\label{fig:sdr_dsl_sequence_generic}}
...
\begin{figure}[htp]
  \centering
  \resizebox{0.90\textwidth}{!}{\inputtikz{\curChapter/fig/dsl/loop/loop}}
  \caption
...
\begin{figure}[htp]
  \centering
  \inputtikz{\curChapter/fig/dsl/nested_loops/nested_loops}
  \caption
    [Nested loops.]
    {Nested loops.}
...
\begin{figure}[htp]
  \centering
  \inputtikz{\curChapter/fig/dsl/sequence_dup/sequence_dup}
  \caption
...
\begin{figure}[htp]
  ...
  \subfloat[][Description of a pipeline: tasks creation, tasks binding and
              ...
              threads).]{
    \inputtikz{\curChapter/fig/dsl/pipeline/pipeline_usr}
    \label{fig:sdr_dsl_pipeline_usr}}
  \\
  \subfloat[][Automatic parallelization of a pipeline description: sequence
              ...
              binding.]{
    \resizebox{0.985\linewidth}{!}{\inputtikz{\curChapter/fig/dsl/pipeline/pipeline_adp}}
    \label{fig:sdr_dsl_pipeline_adp}}
...
\begin{figure}[htp]
  \centering
  \resizebox{0.99\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/transmitter/transmitter}}
  \caption
...
\begin{figure}[htp]
  ...
  \subfloat[][Waiting phase and learning phase 1 \& 2.]{
    \resizebox{0.99\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/receiver/receiver_learning}}
    \label{fig:sdr_dvbs2_receiver_learning}}
  \\
  \subfloat[][Learning phase 3 \& transmission phase.]{
    \resizebox{0.99\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/receiver/receiver_transmission}}
...
Figure~\ref{fig:sdr_dvbs2_receiver} presents the task decomposition of the
...
\begin{figure}[htp]
  \centering
  \resizebox{1.0\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/bfer/bfer}}
  \caption
...
Table~\ref{tab:sdr_dvbs2_tasks_thr_lat} presents the tasks throughputs and
...
\begin{table}[htp]
  ...
  \toprule
                                                                                          & \multicolumn{4}{c}{Throughput (MS/s)}                 & \multicolumn{3}{c}{Latency ($\mu$s)}                                                 &           Time \\
  \cmidrule(lr){2-5} \cmidrule(lr){6-8} \cmidrule(lr){9-9}
                                                                        Stages and Tasks  &              Avg &            Min. &             Max. & $\mathcal{N}_\text{Avg}$ &               Avg &              Min. &              Max. &           (\%) \\
  \midrule
  \rowcolor{Paired-7!15}                  Radio -     \emph{receive} ($t^\text{Rx}_{1}$)  &         1015.86  &         234.20  &         1093.98  &                  431.83  &           527.32  &           489.66  &          2287.24  &          0.94  \\
  ...
  \rowcolor{Paired-7!15}    Synch. Freq. Coarse - \emph{synchronize} ($t^\text{Rx}_{3}$)  &         1979.17  &         665.98  &         2237.38  &                  841.32  &           270.66  &           239.42  &           804.35  &          0.48  \\
  \rowcolor{Paired-7!15}         Filter Matched -      \emph{filter} ($t^\text{Rx}_{4}$)  &          273.85  &         121.60  &          275.25  &                  116.41  &          1956.08  &          1946.13  &          4405.09  &          3.49  \\
...
\begin{figure}[htp]
  \centering
  \subfloat[][Data copy (stage throughput is 40 Mb/s).]{\resizebox{0.485\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/pipeline_copy/pipeline_copy_dat}}\label{plot:sdr_dvbs2_pipeline_copy_dat}}
  \quad
  \subfloat[][Pointer copy (stage throughput is 55 Mb/s).]{\resizebox{0.485\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/pipeline_copy/pipeline_copy_ptr}}\label{plot:sdr_dvbs2_pipeline_copy_ptr}}
  \caption
