...
\begin{figure}[htp]
  \centering
  \resizebox{1.0\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/transmitter/transmitter}}
  \caption
...
\begin{figure}[htp]
  ...
  \subfloat[][Waiting phase and learning phase 1 \& 2.]{
    \resizebox{1.0\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/receiver/receiver_learning}}
    \label{fig:sdr_dvbs2_receiver_learning}}
  \\
  \subfloat[][Learning phase 3 \& transmission phase.]{
    \resizebox{1.0\linewidth}{!}{\inputtikz{\curChapter/fig/dvbs2/receiver/receiver_transmission}}
