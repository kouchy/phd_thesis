...
\begin{figure}[htp]
  \centering
  \subfloat[][Simple chain sequence.]{\includegraphics[width=0.485\textwidth]{\curChapter/fig/dsl/sequence/sequence_chain}\label{fig:sdr_dsl_sequence_chain}}
  \quad
  \subfloat[][Sequence with multiple first and last tasks.]{\includegraphics[width=0.485\textwidth]{\curChapter/fig/dsl/sequence/sequence_generic}\label{fig:sdr_dsl_sequence_generic}}
...
\begin{figure}[htp]
  \centering
  \includegraphics[scale=1.00]{\curChapter/fig/dsl/nested_loops/nested_loops}
  \caption
    [Nested loops.]
    {Nested loops.}
  \label{fig:sdr_dsl_sequence}
...
created. Figure~\ref{fig:sdr_dsl_sequence} shows an example with two loops
...
\begin{figure}[htp]
  ...
  \subfloat[][Automatic parallelization of a pipeline description: sequence
              ...
              binding.]{
    \includegraphics[width=0.985\linewidth]{\curChapter/fig/dsl/pipeline/pipeline_adp}
...
\begin{figure}[htp]
  \centering
  \subfloat[][Data copy (stage throughput is 40 Mb/s).]{\includegraphics[width=0.485\linewidth]{\curChapter/fig/dvbs2/pipeline_copy/pipeline_copy_dat}\label{plot:sdr_dvbs2_pipeline_copy_dat}}
  \quad
  \subfloat[][Pointer copy (stage throughput is 55 Mb/s).]{\includegraphics[width=0.485\linewidth]{\curChapter/fig/dvbs2/pipeline_copy/pipeline_copy_ptr}\label{plot:sdr_dvbs2_pipeline_copy_ptr}}
  \caption
