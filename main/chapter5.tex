...
\begin{figure}[htp]
  \centering
  \subfloat[][Throughput.]{\includegraphics[width=0.7\textwidth]{ldpc/WiMAX_thr_lat/WiMAX_thr}\label{plot:eval_ldpc_WiMAX_thr}}
  % \quad
  \\
  \subfloat[][Latency.]{\includegraphics[width=0.7\textwidth]{ldpc/WiMAX_thr_lat/WiMAX_lat}\label{plot:eval_ldpc_WiMAX_lat}}
  \caption
...
\begin{figure}[htp]
  \centering
  \subfloat[][Throughput.]{\includegraphics[width=0.7\textwidth]{ldpc/DVB-S2_thr_lat/DVB-S2_thr}\label{plot:eval_ldpc_DVB-S2_thr}}
  % \quad
  \\
  \subfloat[][Latency.]{\includegraphics[width=0.7\textwidth]{ldpc/DVB-S2_thr_lat/DVB-S2_lat}\label{plot:eval_ldpc_DVB-S2_lat}}
  \caption
...
estimated exponentials from \eqref{eq:alg_scma_19} are performed. These results
...
logarithms in \eqref{eq:alg_scma_11}, exponentials in \eqref{eq:alg_scma_7},
complex norm and complex subtraction in \eqref{eq:alg_scma_5} and messages
passed from resources to users in \eqref{eq:alg_scma_8}.
...
\eqref{eq:alg_scma_13}. Nevertheless, without using fast math libraries, log-MPA
