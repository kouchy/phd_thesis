...
\begin{figure}
  \centering
  \subfloat[][Without compression.]{\includegraphics[height=6.0cm]{polar/sc_gen_compression/sc_gen_no_compression}\label{fig:polar_sc_gen_compression_wo}}
  % \qquad
  \\
  \subfloat[][With compression.]{\includegraphics[height=6.0cm]{polar/sc_gen_compression/sc_gen_compression}\label{fig:polar_sc_gen_compression_w}}
...
\begin{table}
  ...
  \hline
  \hline
  \multirow{11}{*}{\rotatebox[origin=c]{90}{\textbf{Intel\R Core\TM i7-6700HQ~~~~~~}}}
  ...
  \hline
  \multirow{10}{*}{\rotatebox[origin=c]{90}{\textbf{ARM\R Cortex-A57~~~~~~~~}}}
  %& Algorithm                                                     & Througput per Core     & Througput per Socket    & Latency                 & Power per Bit           & Energy                                \\
  ...
  \hline
  \multirow{5}{*}{\rotatebox[origin=c]{90}{\textbf{Xeon Phi\TM 7120P~~~~~}}}
  %& Algorithm                                                     & Througput per Core     & Througput per Socket    & Latency                 & Power per Bit           & Energy                                \\
