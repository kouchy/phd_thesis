...
%     {a) SCMA encoder with 6 users (layers) and 4 physical resources,
...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}[baseline]
    ...
    \draw[->,>=latex] (ue1_cb_1_0.south east) -- (ue1_cb_3.north) node [midway, fill=white] {\tiny{$h_1$}};
    \draw[->,>=latex] (ue2_cb_1_0.south east) -- (ue2_cb_3.north) node [midway, fill=white] {\tiny{$h_2$}};
    \draw[->,>=latex] (ue3_cb_1_0.south east) -- (ue3_cb_3.north) node [midway, fill=white] {\tiny{$h_3$}};
    \draw[->,>=latex] (ue4_cb_1_0.south east) -- (ue4_cb_3.north) node [midway, fill=white] {\tiny{$h_4$}};
    \draw[->,>=latex] (ue5_cb_1_0.south east) -- (ue5_cb_3.north) node [midway, fill=white] {\tiny{$h_5$}};
    \draw[->,>=latex] (ue6_cb_1_0.south east) -- (ue6_cb_3.north) node [midway, fill=white] {\tiny{$h_6$}};
  ...
  \begin{tikzpicture}[baseline]
    ...
    \node[align=center, minimum width=0.60cm] (n0) at (6.7, 2.20) {\tiny{$\bm{N_0$}}};
    ...
    \draw[->,>=latex] (xj) -- (plus) node [midway, below] {\tiny{$h_j$}};
    \draw[->,>=latex] (x2) -- (plus) node [midway, below] {\tiny{$h_2$}};
    \draw[->,>=latex] (x1) -- (plus) node [midway, above] {\tiny{$h_1$}};
  ...
  \begin{tikzpicture}[baseline]
    ...
    \node[vn, label={[black]left:\tiny{$UE1$}}] (v1_i) at (0.00, 0.00+0.00) {};
    \node[vn, label={[black]left:\tiny{$UE2$}}] (v2_i) at (0.00, 0.25+0.40) {};
    \node[vn, label={[black]left:\tiny{$UE3$}}] (v3_i) at (0.00, 0.50+0.80) {};
    \node[vn, label={[black]left:\tiny{$UE4$}}] (v4_i) at (0.00, 0.75+1.20) {};
    \node[vn, label={[black]left:\tiny{$UE5$}}] (v5_i) at (0.00, 1.00+1.60) {};
    \node[vn, label={[black]left:\tiny{$UE6$}}] (v6_i) at (0.00, 1.25+2.00) {};

    \node[cn, label={[black]right:\tiny{$RES1$}}] (ca_i) at (1.00, 0.25+0.40) {};
    \node[cn, label={[black]right:\tiny{$RES2$}}] (cb_i) at (1.00, 0.50+0.80) {};
    \node[cn, label={[black]right:\tiny{$RES3$}}] (cc_i) at (1.00, 0.75+1.20) {};
    \node[cn, label={[black]right:\tiny{$RES4$}}] (cd_i) at (1.00, 1.00+1.60) {};

    \draw[dotted                                ] (v1_i) -- (ca_i);
    \draw[dotted                                ] (v1_i) -- (cb_i);
    \draw[dotted                                ] (v2_i) -- (cc_i);
    \draw[<-,>=latex, Paired-5, line width=0.7pt] (v2_i) -- (cd_i);
    \draw[dotted                                ] (v3_i) -- (ca_i);
    \draw[dotted                                ] (v3_i) -- (cc_i);
    \draw[dotted                                ] (v4_i) -- (cb_i);
    \draw[->,>=latex, Paired-3, line width=0.7pt] (v4_i) -- (cd_i);
    \draw[dotted                                ] (v5_i) -- (ca_i);
    \draw[->,>=latex, Paired-3, line width=0.7pt] (v5_i) -- (cd_i);
    \draw[dotted                                ] (v6_i) -- (cb_i);
    \draw[dotted                                ] (v6_i) -- (cc_i);
    ...
    \node[vn, label={[black]left:\tiny{$UE1$}}] (v1_ii) at (\xshft+0.00, 0.00+0.00) {};
    \node[vn, label={[black]left:\tiny{$UE2$}}] (v2_ii) at (\xshft+0.00, 0.25+0.40) {};
    \node[vn, label={[black]left:\tiny{$UE3$}}] (v3_ii) at (\xshft+0.00, 0.50+0.80) {};
    \node[vn, label={[black]left:\tiny{$UE4$}}] (v4_ii) at (\xshft+0.00, 0.75+1.20) {};
    \node[vn, label={[black]left:\tiny{$UE5$}}] (v5_ii) at (\xshft+0.00, 1.00+1.60) {};
    \node[vn, label={[black]left:\tiny{$UE6$}}] (v6_ii) at (\xshft+0.00, 1.25+2.00) {};

    \node[cn, label={[black]right:\tiny{$RES1$}}] (ca_ii) at (\xshft+1.00, 0.25+0.40) {};
    \node[cn, label={[black]right:\tiny{$RES2$}}] (cb_ii) at (\xshft+1.00, 0.50+0.80) {};
    \node[cn, label={[black]right:\tiny{$RES3$}}] (cc_ii) at (\xshft+1.00, 0.75+1.20) {};
    \node[cn, label={[black]right:\tiny{$RES4$}}] (cd_ii) at (\xshft+1.00, 1.00+1.60) {};

    \draw[dotted                                ] (v1_ii) -- (ca_ii);
    \draw[dotted                                ] (v1_ii) -- (cb_ii);
    \draw[dotted                                ] (v2_ii) -- (cc_ii);
    \draw[dotted                                ] (v2_ii) -- (cd_ii);
    \draw[->,>=latex, Paired-5, line width=0.7pt] (v3_ii) -- (ca_ii);
    \draw[<-,>=latex, Paired-3, line width=0.7pt] (v3_ii) -- (cc_ii);
    \draw[dotted                                ] (v4_ii) -- (cb_ii);
    \draw[dotted                                ] (v4_ii) -- (cd_ii);
    \draw[dotted                                ] (v5_ii) -- (ca_ii);
    \draw[dotted                                ] (v5_ii) -- (cd_ii);
    \draw[dotted                                ] (v6_ii) -- (cb_ii);
    \draw[dotted                                ] (v6_ii) -- (cc_ii);
    ...
    \node[vn, label={[black]left:\tiny{$UE1$}}] (v1_iii) at (\xshft+\xshft+0.00, 0.00+0.00) {};
    \node[vn, label={[black]left:\tiny{$UE2$}}] (v2_iii) at (\xshft+\xshft+0.00, 0.25+0.40) {};
    \node[vn, label={[black]left:\tiny{$UE3$}}] (v3_iii) at (\xshft+\xshft+0.00, 0.50+0.80) {};
    \node[vn, label={[black]left:\tiny{$UE4$}}] (v4_iii) at (\xshft+\xshft+0.00, 0.75+1.20) {};
    \node[vn, label={[black]left:\tiny{$UE5$}}] (v5_iii) at (\xshft+\xshft+0.00, 1.00+1.60) {};
    \node[vn, label={[black]left:\tiny{$UE6$}}] (v6_iii) at (\xshft+\xshft+0.00, 1.25+2.00) {};

    \node[cn, label={[black]right:\tiny{$RES1$}}] (ca_iii) at (\xshft+\xshft+1.00, 0.25+0.40) {};
    \node[cn, label={[black]right:\tiny{$RES2$}}] (cb_iii) at (\xshft+\xshft+1.00, 0.50+0.80) {};
    \node[cn, label={[black]right:\tiny{$RES3$}}] (cc_iii) at (\xshft+\xshft+1.00, 0.75+1.20) {};
    \node[cn, label={[black]right:\tiny{$RES4$}}] (cd_iii) at (\xshft+\xshft+1.00, 1.00+1.60) {};

    \draw[dotted                                ] (v1_iii) -- (ca_iii);
    \draw[dotted                                ] (v1_iii) -- (cb_iii);
    \draw[dotted                                ] (v2_iii) -- (cc_iii);
    \draw[dotted                                ] (v2_iii) -- (cd_iii);
    \draw[<-,>=latex, Paired-5, line width=0.7pt] (v3_iii) -- (ca_iii);
    \draw[<-,>=latex, Paired-5, line width=0.7pt] (v3_iii) -- (cc_iii);
    \draw[dotted                                ] (v4_iii) -- (cb_iii);
    \draw[dotted                                ] (v4_iii) -- (cd_iii);
    \draw[dotted                                ] (v5_iii) -- (ca_iii);
    \draw[dotted                                ] (v5_iii) -- (cd_iii);
    \draw[dotted                                ] (v6_iii) -- (cb_iii);
    \draw[dotted                                ] (v6_iii) -- (cc_iii);
