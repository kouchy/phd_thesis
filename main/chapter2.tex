...
\begin{figure}[htp]
  \centering
  \input{main/chapter2/fig/polar/sc_decoder/sc_decoder}
...
\begin{figure}[htp]
  \centering
  \input{main/chapter2/fig/polar/tree_pruning_example/tree_pruning_example}
  \caption
...
\begin{figure}[htp]
  \centering
  \input{main/chapter2/fig/ldpc/tanner_graph/tanner_graph}
...
\begin{figure}[htp]
  ...
  \subfloat[][Message Passing Algorithm based on Bayesian factor graph:\linebreak
    ...
    \input{main/chapter2/fig/scma/codec/codec_dec}
  }
  \caption
