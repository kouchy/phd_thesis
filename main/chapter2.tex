...
\begin{figure}
  \centering
  \subfloat[][Without compression.]{\includegraphics[height=5.0cm]{polar/sc_gen_compression/sc_gen_no_compression}\label{fig:polar_sc_gen_compression_wo}}
  \qquad
  \subfloat[][With compression.]{\includegraphics[height=5.0cm]{polar/sc_gen_compression/sc_gen_compression}\label{fig:polar_sc_gen_compression_w}}
