...
\begin{figure}[htp]
  ...
  %preaction={fill=Paired-1!40}, pattern=north west lines, pattern color=black!80!Paired-1!70

  \node[draw=black,    circle, minimum height=0.6cm, text=black                                                                                                                                                    ] (l3_g0) at (0.0, 0.0) {};
  \node[draw=black,    circle, minimum height=0.6cm, text=black                                                                                                                                                    ] (l3_g1) at (1.0, 0.0) {};
  \node[draw=black,    circle, minimum height=0.6cm, text=black                                                                                                                                                    ] (l3_g2) at (2.0, 0.0) {};
  \node[draw=black,    circle, minimum height=0.6cm, text=black, fill=black                                                                                                                                        ] (l3_g3) at (3.0, 0.0) {};
  \node[draw=black,    circle, minimum height=0.6cm, text=black                                                                                                                                                    ] (l3_g4) at (4.0, 0.0) {};
  \node[draw=black,    circle, minimum height=0.6cm, text=black, fill=black                                                                                                                                        ] (l3_g5) at (5.0, 0.0) {};
  \node[draw=black,    circle, minimum height=0.6cm, text=black, fill=black                                                                                                                                        ] (l3_g6) at (6.0, 0.0) {};
  \node[draw=black,    circle, minimum height=0.6cm, text=black, fill=black                                                                                                                                        ] (l3_g7) at (7.0, 0.0) {};

  \node[draw=Paired-1, circle, minimum height=0.6cm, text=black, preaction={fill=Paired-1!40}, pattern=north west lines, pattern color=black!80!Paired-1!70, label={[black]above:\small{\texttt{R0}}}              ] (l2_g0) at (0.5, 1.5) {};
  \node[draw=Paired-7, circle, minimum height=0.6cm, text=black, preaction={fill=Paired-7!40}, pattern=crosshatch dots,  pattern color=black!80!Paired-7!70, label={[black]above:\small{\texttt{REP}}}             ] (l2_g1) at (2.5, 1.5) {};
  \node[draw=Paired-7, circle, minimum height=0.6cm, text=black, preaction={fill=Paired-7!40}, pattern=crosshatch dots,  pattern color=black!80!Paired-7!70, label={[black]above:\small{\texttt{REP}}}             ] (l2_g2) at (4.5, 1.5) {};
  \node[draw=Paired-3, circle, minimum height=0.6cm, text=black, preaction={fill=Paired-3!40}, pattern=north east lines, pattern color=black!80!Paired-3!70, label={[black]above:\small{\texttt{R1}}}              ] (l2_g3) at (6.5, 1.5) {};

  \node[draw=Paired-7, circle, minimum height=0.6cm, text=black, preaction={fill=Paired-7!40}, pattern=crosshatch dots,  pattern color=black!80!Paired-7!70, label={[black]above:\small{\texttt{REP}}}             ] (l1_g0) at (1.5, 3.0) {};
  \node[draw=Paired-5, circle, minimum height=0.6cm, text=black, preaction={fill=Paired-5!40}, pattern=horizontal lines, pattern color=black!80!Paired-5!70, label={[black]above:\small{\texttt{SPC$_\texttt{4}$}}}] (l1_g1) at (5.5, 3.0) {};

  \node[draw=gray,     circle, minimum height=0.6cm, text=black, fill=gray!40                                                                              , label={[black]above:\small{\texttt{?}}}               ] (l0_g0) at (3.5, 4.5) {};
  ...
  \node[draw=Paired-7, circle, minimum height=0.6cm, text=black, preaction={fill=Paired-7!40}, pattern=crosshatch dots,  pattern color=black!80!Paired-7!70, label={[black]above:\small{\texttt{REP}}}             ] (l1_g0_cut) at ( 9.5, 1.5) {};
  \node[draw=Paired-5, circle, minimum height=0.6cm, text=black, preaction={fill=Paired-5!40}, pattern=horizontal lines, pattern color=black!80!Paired-5!70, label={[black]above:\small{\texttt{SPC$_\texttt{4}$}}}] (l1_g1_cut) at (13.5, 1.5) {};
  \node[draw=gray,     circle, minimum height=0.6cm, text=black, fill=gray!40,                                                                               label={[black]above:\small{\texttt{?}}}               ] (l0_g0_cut) at (11.5, 3.0) {};
