...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}%[scale=\tikzscale]
    ...
    \draw[->,>=latex] (11.25, \H) -- (11.25, -0.4) node [midway, text=black, fill=white,rotate=90] {\small{Layer (tree depth)}};
  \end{tikzpicture}
...
\begin{figure}[htp]
  ...
  \node[draw=Paired-1, circle, minimum height=0.6cm, text=black, pattern=north west lines, pattern color=Paired-1!70, label={[black]above:\small{\texttt{R0}}} ] (l2_g0) at (0.5, 1.5) {};
  \node[draw=Paired-7, circle, minimum height=0.6cm, text=black, pattern=crosshatch dots,  pattern color=Paired-7!70, label={[black]above:\small{\texttt{REP}}}] (l2_g1) at (2.5, 1.5) {};
  \node[draw=Paired-7, circle, minimum height=0.6cm, text=black, pattern=crosshatch dots,  pattern color=Paired-7!70, label={[black]above:\small{\texttt{REP}}}] (l2_g2) at (4.5, 1.5) {};
  \node[draw=Paired-3, circle, minimum height=0.6cm, text=black, pattern=north east lines, pattern color=Paired-3!70, label={[black]above:\small{\texttt{R1}}} ] (l2_g3) at (6.5, 1.5) {};

  \node[draw=Paired-7, circle, minimum height=0.6cm, text=black, pattern=crosshatch dots,  pattern color=Paired-7!70, label={[black]above:\small{\texttt{REP}}}] (l1_g0) at (1.5, 3.0) {};
  \node[draw=Paired-5, circle, minimum height=0.6cm, text=black, pattern=horizontal lines, pattern color=Paired-5!70, label={[black]above:\small{\texttt{SPC$_\texttt{4}$}}}] (l1_g1) at (5.5, 3.0) {};

  \node[draw=gray,     circle, minimum height=0.6cm, text=black, fill=gray!30                                       , label={[black]above:\small{\texttt{?}}}  ] (l0_g0) at (3.5, 4.5) {};
  ...
  \node[draw=Paired-7, circle, minimum height=0.6cm, text=black, pattern=crosshatch dots,  pattern color=Paired-7!70, label={[black]above:\small{\texttt{REP}}}] (l1_g0_cut) at ( 9.5, 1.5) {};
  \node[draw=Paired-5, circle, minimum height=0.6cm, text=black, pattern=horizontal lines, pattern color=Paired-5!70, label={[black]above:\small{\texttt{SPC$_\texttt{4}$}}}] (l1_g1_cut) at (13.5, 1.5) {};
  \node[draw=gray,     circle, minimum height=0.6cm, text=black, fill=gray!30,                                        label={[black]above:\small{\texttt{?}}}  ] (l0_g0_cut) at (11.5, 3.0) {};
