...
\subsection{Polar Coding Scheme}
...
\subsection{Successive Cancellation Algorithm}
...
\subsection{Successive Cancellation List Algorithm}
...
\subsection{CRC concatenation scheme}
...
\subsection{Simplified Decoders}
...
\subsection{Adaptive SCL decoding algorithm}
...
\subsection{Generic and Flexible Polar Decoders}
...
\subsection{Turbo Coding Scheme}
...
\begin{figure}[htp]
  ...
  \label{fig:ctx_codes_parity_checks}
\end{figure}

The construction of an LDPC code is based on the combination of many
parity-check nodes. Fig.~\ref{fig:ctx_codes_parity_checks} is an example of LDPC
...
parity-check matrix corresponding to the Fig.~\ref{fig:ctx_codes_parity_checks}
Tanner graph is:
\begin{equation*}
\bm{\mathcal{H}} =
\begin{bmatrix}
...
Fig.~\ref{fig:ctx_codes_parity_checks} is here to help to the comprehension and
...
% \begin{figure}[htp]
%   \centering
%   \includegraphics{ldpc/tanner_graph/tanner_graph}
