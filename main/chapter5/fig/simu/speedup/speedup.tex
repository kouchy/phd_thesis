...
\begin{document}
  ...
  \begin{scope}[spy using outlines={rectangle, magnification=3.0, width=4.35cm, height=5cm, connect spies}]
    ...
    \begin{axis}[/pgfplots/table/ignore chars={ }, %footnotesize,
        ...
        \addplot[mark=otimes,   Paired-1!60, semithick] table [x=t, y expr=\thisrow{Mbps}/126.409] {./dat/Intel_Xeon_Gold_6240.txt   }; \label{plot:line4}
        \addplot[mark=square,   Paired-7,    semithick] table [x=t, y expr=\thisrow{Mbps}/ 81.759] {./dat/Intel_Xeon_E5-2680v3.txt   }; \label{plot:line5}
        \addplot[mark=+,        Paired-9,    semithick] table [x=t, y expr=\thisrow{Mbps}/113.040] {./dat/AMD_EPYC_7702.txt          }; \label{plot:line6}
