...
\begin{document}
  \begin{tikzpicture}
    \begin{axis}[/pgfplots/table/ignore chars={ }, %footnotesize,
        ...
        \addplot[mark=square,   Paired-7,    semithick] table [x index=0, y index=1] {./dat/samples_generated_decoders_sizes_after_compression.dat}; \label{plot:line1}
        \addplot[mark=triangle, Paired-3,    semithick] table [x index=0, y index=3] {./dat/samples_generated_decoders_sizes_after_compression.dat}; \label{plot:line2}
        \addplot[mark=o,        Paired-1,    semithick] table [x index=0, y index=5] {./dat/samples_generated_decoders_sizes_after_compression.dat}; \label{plot:line3}
        \addplot[mark=none,     Paired-5              ] coordinates {(6,32) (16,32)}; \label{plot:line4}
