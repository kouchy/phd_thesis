...
\begin{document}
  \begin{tikzpicture}
    \begin{axis}[/pgfplots/table/ignore chars={ }, %footnotesize,
        ...
        \addplot[mark=square,   Paired-5,    semithick                              ] table [x index=0, y index=1] {./dat/samples_generated_decoders_sizes.dat}; \label{plot:line1}
        \addplot[mark=triangle, Paired-1,    semithick                              ] table [x index=0, y index=3] {./dat/samples_generated_decoders_sizes.dat}; \label{plot:line2}
        \addplot[mark=o,        Paired-1,    semithick, dashed, mark options={solid}] table [x index=0, y index=5] {./dat/samples_generated_decoders_sizes.dat}; \label{plot:line3}
