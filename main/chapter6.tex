...
processing are repeated indefinitely when the system in on. So a sequence is
executed in loop, when the last task is executed, the next task is the first
one. The user can control if the sequence should restart by giving a
