...
\begin{table}[htp]
  \centering
  \caption
    [Tested DVB-S2 configurations (MODCOD).]
    {Tested DVB-S2 configurations (MODCOD).}
...
\begin{table}[htp]
  ...
  \caption
    ...
    error-free SNR zone).
    The sequential tasks are represented by orange rows, the slowest
    \emph{sequential} stage is in red and the slowest of all stages is in blue.
    $\bm{\mathcal{N}}_\text{\textbf{Avg.}}$ is the normalized average throughput
    considering the $K_\text{BCH} = 14232$ information bits independently of the
    tasks.}
  ...
  \begin{tabular}{r | r r r r  | r r r | r}
    ...
    \rowcolor{Paired-7!15}
                            Radio -      \emph{receive} ($t^\text{Rxt}_{1}$)  &         1015.86  &           234.20  &          1093.98  &                                 431.83  &           527.32  &           489.66  &          2287.24  &          0.94  \\ \hline
                                                             \textbf{Stage 1} & \textbf{1015.86} &   \textbf{234.20} &  \textbf{1093.98} &                         \textbf{431.83} &   \textbf{527.32} &   \textbf{489.66} &  \textbf{2287.24} &  \textbf{0.94} \\ % T = 16*33480/L
                                                                              &                  &                   &                   &                                         &                   &                   &                   &                \\
                   Multiplier AGC -    \emph{imultiply} ($t^\text{Rxt}_{2}$)  &          864.41  &           420.05  &           935.71  &                                 367.45  &           619.71  &           572.49  &          1275.28  &          1.11  \\
    \rowcolor{Paired-7!15}
              Synch. Freq. Coarse -  \emph{synchronize} ($t^\text{Rxt}_{3}$)  &         1979.17  &           665.98  &          2237.38  &                                 841.32  &           270.66  &           239.42  &           804.35  &          0.48  \\
    \rowcolor{Paired-7!15}
                   Filter Matched -       \emph{filter} ($t^\text{Rxt}_{4}$)  &          273.85  &           121.60  &           275.25  &                                 116.41  &          1956.08  &          1946.13  &          4405.09  &          3.49  \\ \hline
            ...
            Synch. Freq. Fine P/F -  \emph{synchronize} ($t^\text{Rxt}_{11}$) &          132.40  &            62.59  &           140.88  &                                  112.56 &          2022.98  &          1901.24  &          4279.30  &          3.61  \\ \hline
                  ...
                  Noise Estimator -     \emph{estimate} ($t^\text{Rxt}_{13}$) &          626.12  &           151.24  &           656.09  &                                 550.06  &           413.98  &           395.07  &          1713.87  &          0.74  \\ \hline
                                                             \textbf{Stage 6} &  \textbf{405.16} &   \textbf{111.73} &   \textbf{421.72} &                         \textbf{355.94} &   \textbf{639.75} &   \textbf{614.62} &  \textbf{2319.89} &  \textbf{1.14} \\ % T = 16*16200/L
                                                                              &                  &                   &                   &                                         &                   &                   &                   &                \\
                        Modem PSK -   \emph{demodulate} ($t^\text{Rxt}_{14}$) &           46.07  &            42.12  &            46.28  &                                  40.47  &          5626.34  &          5600.83  &          6153.50  &         10.05  \\
...
\begin{figure}[htp]
  \centering
  \subfloat[fig:dvbs2_pipeline_dat_copy][Data copy (stage throughput is 40 Mb/s).]{\includegraphics[width=0.485\linewidth]{dvbs2/pipeline_copy/pipeline_copy_dat}}
  \quad
  \subfloat[fig:dvbs2_pipeline_ptr_copy][Pointer copy (stage throughput is 55 Mb/s).]{\includegraphics[width=0.485\linewidth]{dvbs2/pipeline_copy/pipeline_copy_ptr}}
  \caption
