...
\begin{document}
  \begin{tikzpicture}[baseline]
    ...
    \node[fill=Paired-9!40             , minimum width=0.8cm, minimum height=0.4cm, label={[black]left:\footnotesize{Msg. from $RES1$ to $UE3$ ($\mu_x^1$)}}] (m2) at (\rth+0.7+4.10, -1.1-2.7) {};
    \node[fill=Paired-11!40            , minimum width=0.8cm, minimum height=0.4cm, label={[black]left:\footnotesize{Msg. from $RES3$ to $UE3$ ($\mu_x^3$)}}] (m4) at (\rth+0.7+4.10, -1.7-2.7) {};
    ...
    \node[er2] (r0_e0) at (\lft+1.4, -\vs) {\tiny{$\mu_1^1$}};
    \node[er2] (r0_e1) at (\lft+2.1, -\vs) {\tiny{$\mu_2^1$}};
    \node[er2] (r0_e2) at (\lft+2.8, -\vs) {\tiny{$\mu_3^1$}};
    \node[er2] (r0_e3) at (\lft+3.5, -\vs) {\tiny{$\mu_4^1$}};
    ...
    \node[er4] (r1_e0) at (\rth+1.4, -\vs) {\tiny{$\mu_1^3$}};
    \node[er4] (r1_e1) at (\rth+2.1, -\vs) {\tiny{$\mu_2^3$}};
    \node[er4] (r1_e2) at (\rth+2.8, -\vs) {\tiny{$\mu_3^3$}};
    \node[er4] (r1_e3) at (\rth+3.5, -\vs) {\tiny{$\mu_4^3$}};
    ...
    \draw[<->,>=latex,black] (-0.35, 0.75)  -- (15.05, 0.75)  node (arrow1) [midway, text=black, fill=white] {\small{\textit{Resources to users} messages}};
