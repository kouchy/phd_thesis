...
# set key options
set key top right width -2 height 0 font 'Helvetica, 12'
...
plot datafile using 1:20 i 0 with linespoint title columnheader(2),\
     ...
     datafile using 1:20 i 3 with linespoint title columnheader(2),\
     datafile using 1:20 i 4 with linespoint title columnheader(2),\
     datafile using 1:20 i 5 with linespoint title columnheader(2)
