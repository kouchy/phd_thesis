...
\begin{document}
	...
	\draw[->,>=latex] (l0_g0) to [out=0,in=60,looseness=8] (l0_g0) node [right, text=black, xshift=0.6cm, yshift=0.2cm] {$h$};
	...
	\draw[->,>=latex] (l0_g0_cut) to [out=0,in=60,looseness=8] (l0_g0_cut) node [right, text=black, xshift=0.6cm, yshift=0.2cm] {$h$};
