...
\begin{document}
  ...
  \begin{tikzpicture}%[scale=\tikzscale]
    ...
    \draw[->,>=latex] (l0_g0) to [out=0,in=60,looseness=4] (l0_g0) node [right, text=black, xshift=0.425cm, yshift=0.300cm] {\tiny{$h$}};
  ...
  \begin{tikzpicture}
    ...
    \draw[->,>=latex] (l0_g0_t) to [out=120,in=60,looseness=4] (l0_g0_t) node [left, text=black, yshift=0.725cm, xshift=0.30cm] {\tiny{$h_d$}};
  \end{tikzpicture}
  \begin{tikzpicture}
    \draw (0,-0.3) -- (0,1.45) node [midway, text=black] {};
  \end{tikzpicture}
  \begin{tikzpicture}
    ...
    \draw[->,>=latex] (l0_g0_t) to [out=120,in=60,looseness=4] (l0_g0_t) node [left, text=black, yshift=0.725cm, xshift=0.35cm] {\tiny{$rep$}};
  \end{tikzpicture}
  \begin{tikzpicture}
    \draw (0,-0.3) -- (0,1.45) node [midway, text=black] {};
  \end{tikzpicture}
  \begin{tikzpicture}
    ...
    \draw[->,>=latex] (l0_g0_t) to [out=120,in=60,looseness=4] (l0_g0_t) node [left, text=black, yshift=0.725cm, xshift=0.35cm] {\tiny{$spc$}};
  \end{tikzpicture}
  ...
  \begin{tikzpicture}%[scale=\tikzscale]
    ...
    \draw[->,>=latex] (l0_g0_t) to [out=180,in=120,looseness=4] (l0_g0_t) node [right, text=black, xshift=-0.87cm, yshift=0.300cm] {\tiny{$h$}};
  \end{tikzpicture}
  \begin{tikzpicture}
    \draw (0,-0.3) -- (0,1.45) node [midway, text=black] {};
  \end{tikzpicture}
