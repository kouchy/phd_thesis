...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a4paper,11pt,fleqn,oneside]{book} %% ajouter oneside pour la version numérique
...
\titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    \node[yshift=-6cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
        \draw[fill=bleuUni,bleuUni] (0,0) rectangle(18.5mm,15mm);
        \node[anchor=north east,yshift=-5.2cm,xshift=17mm,minimum height=30mm,inner sep=0mm] at (current page.north west)
        ...
        \node[anchor=north west,yshift=-5.2cm,xshift=20mm,text width=\textwidth,minimum height=30mm,inner sep=0mm] at (current page.north west)
