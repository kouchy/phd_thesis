...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{eulervm} % Utopia font-typesetting including mathematical formula compatible with newer TeX-Distributions (>2010)
...
\setlength{\evensidemargin}{0.8mm} % = 26.2mm - 1in (from hoffset)
\else
\setlength{\oddsidemargin}{6mm} % 37mm - 1in (from hoffset)
\setlength{\evensidemargin}{6.2mm} % = 26.2mm - 1in (from hoffset)
\fi
\makeatother
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    \node[yshift=-8cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
        \draw[fill=bleuUni,bleuUni] (0,0) rectangle(35.5mm,15mm);
