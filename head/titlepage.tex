  ...
  \thispagestyle{empty}
   \begin{center}
    ...
    \vspace*{1.5em}
    {
      ...
      \noindent {\fontsize{24}{24} \textbf{Méthodes d'optimisation et de parallélisation pour la radio logicielle}% sur processeurs généralistes}
    }
...
%     Xxxx       \textsc{Xxxx}       & - & Xxxx                        & - & Xxxx                 & \textit{Président}    \\
      ...
      Matthieu   \textsc{Gautier}    & - & Maître de Conférences, HDR  & - & Université de Rennes & \textit{Rapporteur}   \\
