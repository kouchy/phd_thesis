  ...
  \thispagestyle{empty}
   \begin{center}
    \begin{tikzpicture}[overlay,remember picture]
      ...
      \node[inner sep=5,anchor=north west] at ($(NW)!.05!(SE)$) {\includegraphics[height=2.5cm]{ub}};

      \node[inner sep=5,anchor=north east] at ($(NE)!.05!(SW)$) {\includegraphics[height=2.5cm]{inr_logo_rouge}};
    \end{tikzpicture}
