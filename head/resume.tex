...
plus en plus, avec l'émergence de nouveaux standards de communications complexes
...
décodage différents et un des enjeux principal de cette thèse est de proposer
...
sont discutées. L'idée étant d'abstraire les stratégies d'optimisation possibles
en étudiant un sous-ensemble de décodeurs représentatif.
