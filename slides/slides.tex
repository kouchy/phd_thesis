...
\titlegraphic{\includegraphics[height=.8cm]{../head/pic/inr_logo_rouge.png} \hfil %
              ...
              \includegraphics[height=.6cm]{./pic/labri.png} \hfil %
              \includegraphics[height=.8cm]{./pic/inp.png}}
...
\include{section/polar}
\include{section/mipp}
\include{section/aff3ct}
\include{section/edsl}
