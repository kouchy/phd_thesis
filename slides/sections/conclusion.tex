...
\begin{frame}{Conclusion}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      \item High performance implementations of signal processing algorithms%~\cite{Cassagne2015c,Cassagne2016a,Cassagne2016b,Leonardon2019,Ghaffari2019}
    ...
    \begin{itemize}
      \item \MIPP: Flexible, portable and efficient SIMD description of signal processing algorithms%~\cite{Cassagne2018}
